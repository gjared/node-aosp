...
/* Note: we are getting warnings for multiple definition when building
 * from the AOSP, so protect this here
...
/* Note: we are getting warnings about redefinition from
 * ./build/core/combo/include/arch/linux-arm/AndroidConfig.h
 * when building from the AOSP so protect this now */
