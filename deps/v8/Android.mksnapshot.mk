...
LOCAL_MODULE := node-mksnapshot.$(TARGET_ARCH)
...
NODE-GEN3 := $(intermediates)/libraries.cc
$(NODE-GEN3): SCRIPT := $(intermediates)/js2c.py
$(NODE-GEN3): $(LOCAL_JS_LIBRARY_FILES) $(JS2C_PY)
	@echo "Generating libraries.cc"
	@mkdir -p $(dir $@)
	python $(SCRIPT) $(NODE-GEN3) CORE off $(LOCAL_JS_LIBRARY_FILES)
LOCAL_GENERATED_SOURCES := $(intermediates)/libraries.cc

# Generate experimental-libraries.cc
NODE-GEN4 := $(intermediates)/experimental-libraries.cc
$(NODE-GEN4): SCRIPT := $(intermediates)/js2c.py
$(NODE-GEN4): $(LOCAL_JS_EXPERIMENTAL_LIBRARY_FILES) $(JS2C_PY)
	@echo "Generating experimental-libraries.cc"
	@mkdir -p $(dir $@)
	python $(SCRIPT) $(NODE-GEN4) EXPERIMENTAL off $(LOCAL_JS_EXPERIMENTAL_LIBRARY_FILES)
